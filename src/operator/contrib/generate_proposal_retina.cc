...
class GenProposalRetinaOp : public Operator{
 public:
  ...
  virtual void Forward(const OpContext &ctx,
    ...
    if (param_.iou_loss) {
      gen_proposal_retina_utils::IoUTransformInv(workspace_proposals, bbox_deltas, im_info, param_.feature_stride, param_.clip_boxes,
                                          &(workspace_proposals));
    } else {
      gen_proposal_retina_utils::BBoxTransformInv(workspace_proposals, bbox_deltas, im_info, param_.feature_stride, param_.clip_boxes,
                                           &(workspace_proposals));
    }

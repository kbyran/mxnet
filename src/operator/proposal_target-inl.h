...
class ProposalTargetOp : public Operator {
 ...
 //   printf("PROPOSAL_TARGET START\n");
    ...
    const index_t num_gtbbox_ignore = in_data[proposal_target_enum::kGtBboxesIgnore].Size() / (num_image * 5);
    ...
    Tensor<xpu, 3, DType> xpu_gt_bboxes_ignore = in_data[proposal_target_enum::kGtBboxesIgnore].
  ...
  virtual void Backward(const OpContext &ctx,
    ...
    Tensor<xpu, 3, DType> gt_bboxes_ignore = in_grad[proposal_target_enum::kGtBboxesIgnore].get_with_shape<xpu, 3, DType>(Shape3(num_image, num_gtbbox_ignore, 5), s);
